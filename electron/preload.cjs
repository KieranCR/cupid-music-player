...
contextBridge.exposeInMainWorld('cupid', {
  ...
  getStreamUrl: (title, artist, options) => ipcRenderer.invoke('get-stream-url', title, artist, options),
  saveStreamSource: (title, artist, source) => ipcRenderer.invoke('save-stream-source', title, artist, source),
  clearStreamSource: (title, artist) => ipcRenderer.invoke('clear-stream-source', title, artist),
